...
export default function StudioPage() {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="font-display text-3xl font-bold">{t.coreCapabilities}</h2>
      ...
      <section
        ...
        style={{ borderColor: theme.border }}
      >
        <h2 className="font-display text-3xl font-bold">{t.executionModel}</h2>
      ...
      <section
        ...
        style={{ borderColor: theme.border }}
      >
        <h2 className="font-display text-3xl font-bold">{t.businessOutcomes}</h2>
